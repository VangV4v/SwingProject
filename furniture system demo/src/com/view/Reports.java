...
public class Reports extends javax.swing.JPanel implements PdfPCellEvent, PdfPTableEvent {
    ...
    private String revenue, revenuePro, revenueStaff, daily, weekly, monthly, year, no, orderID, cusName, transactionTime, amount;
    private String orderDate, totalOrder, month, revenueUpper, statisticDay, to, totalRevenue, chartWeek, chartMonth, chartYear, revenueChart;
    private String lbl5, lbl8;
    ...
    public void dich() {
        ...
        if (nn.equals(vn)) {
            ...
            try {
                ...
                jLabel14.setText(resource.getString("report"));
                jLabel4.setText(resource.getString("logout"));
                jLabel6.setText(resource.getString("time"));
                jLabel7.setText(resource.getString("typeofreport"));
                btnCreate.setText(resource.getString("create"));
                btnPrint.setText(resource.getString("export"));
                btnChart.setText(resource.getString("chart"));
                btnReset.setText(resource.getString("reset"));
                revenue = resource.getString("revenue");
                revenuePro = resource.getString("revenuePro");
                revenueStaff = resource.getString("revenueStaff");
                daily = resource.getString("daily");
                weekly = resource.getString("weekly");
                monthly = resource.getString("monthly");
                year = resource.getString("year");
                no = resource.getString("no");
                orderID = resource.getString("orderid");
                cusName = resource.getString("cusname");
                transactionTime = resource.getString("transactionTime");
                amount = resource.getString("amount");
                orderDate = resource.getString("date");
                totalOrder = resource.getString("totalOrder");
                month = resource.getString("month");
                revenueUpper = resource.getString("revenueUpper");
                statisticDay = resource.getString("statisticDay");
                to = resource.getString("to");
                totalRevenue = resource.getString("totalRevenue");
                chartWeek = resource.getString("chartWeek");
                chartMonth = resource.getString("chartMonth");
                chartYear = resource.getString("chartYear");
                revenueChart = resource.getString("revenueChart");
                if (cbxType.getSelectedItem().toString().equals(revenue)) {
                    lbl5 = resource.getString("totalOrder");
                    lbl8 = resource.getString("totalRevenue");
                }
            } catch (Exception e) {
            }
        }
    ...
    public PdfPTable getHeaderTable(PdfWriter writer) throws DocumentException, IOException {
        ...
        PdfPCell cell = new PdfPCell(new Phrase(revenueUpper, FONT_SIZE_18_BOLD));
        cell.setColspan(4);
        cell.setRowspan(4);
