...
public class Search extends javax.swing.JFrame {
    ...
    public Search(String a, String n) {
        nn = a;
    }
    ...
    private void translate() {
        ...
        if (nn.equals(vn)) {
            ...
            try {
                ...
                jLabel23.setText(resource.getString("search"));
                btnSelect.setText(resource.getString("select"));
                notification = resource.getString("notification");
                errorSearch = resource.getString("errorSearch");
                id = resource.getString("cusid");
                cusName = resource.getString("cusname");
                gender = resource.getString("gender");
                birthdate = resource.getString("birthdate");
                address = resource.getString("address");
                phone = resource.getString("phone");
                status = resource.getString("status");
                proID = resource.getString("proid");
                proName = resource.getString("proname");
                supplier = resource.getString("supplier");
                category = resource.getString("category");
                unitPrice = resource.getString("unitprice");
                sellPrice = resource.getString("sellprice");
                quantity = resource.getString("unitinstock");
            } catch (Exception e) {
            }
        }
        if (nn.equals(uk)) {
    ...
    private ArrayList search() {
        ...
        if (form.equals("Customer")) {
            ...
            for (int i = 0; i < arr.size(); i++) {
                if (((Customer) arr.get(i)).getStatus().equals("Enable")) {
                    String name = ((Customer) arr.get(i)).getCustomerName().trim();
                    String phone = ((Customer) arr.get(i)).getPhone().trim();
                    if (name.contains(txtSearch.getText()) || phone.contains(txtSearch.getText())) {
            ...
            for (int i = 0; i < arr.size(); i++) {
                if (((Product) arr.get(i)).getStatus().equals("Enable")) {
                    String id = ((Product) arr.get(i)).getProductID().trim();
                    String name = ((Product) arr.get(i)).getProductName().trim();
                    String supplier = Dao_Suppliers.search(((Product) arr.get(i)).getSupplierID()).getCompanyName();
                    String category = Dao_Categories.searchid(((Product) arr.get(i)).getCategoryID()).getCategoryName();
                    if (id.contains(txtSearch.getText()) || name.contains(txtSearch.getText()) || supplier.contains(txtSearch.getText()) || category.contains(txtSearch.getText())) {
