    ...
    public void dich() {
        ...
        if (nn.equals(vn)) {
            ...
            try {
                ...
                jlbHome.setText(resource.getString("homepage"));
                jlbProduct.setText(resource.getString("product"));
                jlbCategory.setText(resource.getString("category"));
                jlbSupplier.setText(resource.getString("supplier"));
                jlbPromotion.setText(resource.getString("promotion"));
                jlbShipper.setText(resource.getString("shipper"));
                jlbReport.setText(resource.getString("report"));
                jlbStaff.setText(resource.getString("staff"));
                jLabel1.setText(resource.getString("loginAdmin"));
            } catch (Exception e) {
            }
        }
        if (nn.equals(uk)) {
