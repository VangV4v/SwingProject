...
public class Customers extends javax.swing.JPanel {
    ...
    private String id, enterCusName, correctCusName, chooseDate, enterCusPhone, correctCusPhone, enterCusAddress, correctCusAddress, selectCusGender;
    private String notification, existPhone, addedCus, notAddCus, cannotAddCus, updatedCus, notUpdateCus, selectCustomer, deleteCus, deletedCus, notDeleteCus;
    /**
    ...
    private void translate() {
        ...
        if (nn.equals(vn)) {
            ...
            try {
                ...
                jLabel14.setText(resource.getString("customermanage"));
                jLabel4.setText(resource.getString("logout"));
                jLabel7.setText(resource.getString("cusname"));
                jLabel6.setText(resource.getString("birthdate"));
                jLabel8.setText(resource.getString("phone"));
                jLabel10.setText(resource.getString("address"));
                jLabel12.setText(resource.getString("gender"));
                jLabel11.setText(resource.getString("status"));
                radMale.setText(resource.getString("male"));
                radFemale.setText(resource.getString("female"));
                radEnable.setText(resource.getString("enable"));
                radDisable.setText(resource.getString("disable"));
                btnAdd.setText(resource.getString("add"));
                btnUpdate.setText(resource.getString("update"));
                btnDelete.setText(resource.getString("delete"));
                btnReset.setText(resource.getString("reset"));
                id = resource.getString("cusid");
                enterCusName = resource.getString("enterCusName");
                correctCusName = resource.getString("correctCusName");
                chooseDate = resource.getString("chooseDate");
                enterCusPhone = resource.getString("enterCusPhone");
                correctCusPhone = resource.getString("correctCusPhone");
                enterCusAddress = resource.getString("enterCusAddress");
                correctCusAddress = resource.getString("correctCusAddress");
                selectCusGender = resource.getString("selectCusGender");
                notification = resource.getString("notification");
                existPhone = resource.getString("existPhone");
                addedCus = resource.getString("addedCus");
                notAddCus = resource.getString("notAddCus");
                cannotAddCus = resource.getString("cannotAddCus");
                updatedCus = resource.getString("updatedCus");
                notUpdateCus = resource.getString("notUpdateCus");
                selectCustomer = resource.getString("selectCustomer");
                deleteCus = resource.getString("deleteCus");
                deletedCus = resource.getString("deletedCus");
                notDeleteCus = resource.getString("notDeleteCus");
            } catch (Exception e) {
            }
        }
        if (nn.equals(uk)) {
    ...
    private void getCustomers(ArrayList arr) {
        ...
        Object[] obj = new Object[]{id, jLabel7.getText(), jLabel12.getText(), jLabel6.getText(), jLabel8.getText(), jLabel10.getText()};
        DefaultTableModel tableModel = new DefaultTableModel(obj, 0);
        tblCustomer.setModel(tableModel);

        for (int i = 0; i < arr.size(); i++) {
            Object[] objCus = new Object[6];
    ...
    private ArrayList search() {
        ...
        for (int i = 0; i < arr.size(); i++) {
            String id = ((Customer) arr.get(i)).getCustomerID().trim();
            ...
            if (id.contains(text) || name.contains(text) || phone.contains(text)) {
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        if (customer == null) {
            if (!check().equals("")) {
                ...
                Common.notify(existPhone, notification, JOptionPane.WARNING_MESSAGE);
            } else {
                ...
                if (b) {
                    Common.notify(addedCus, notification, JOptionPane.INFORMATION_MESSAGE);
                    getCustomers(Dao_Customer.getCustomers());
                    refresh();
                } else {
                    Common.notify(notAddCus, notification, JOptionPane.ERROR_MESSAGE);
                }
            }
        } else {
            Common.notify(cannotAddCus, notification, JOptionPane.WARNING_MESSAGE);
        }
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        if (customer != null) {
            if (!check().equals("")) {
                ...
                if (b) {
                    Common.notify(updatedCus, notification, JOptionPane.INFORMATION_MESSAGE);
                    getCustomers(Dao_Customer.getCustomers());
                    refresh();
                } else {
                    Common.notify(notUpdateCus, notification, JOptionPane.ERROR_MESSAGE);
                }
            }
        } else {
            Common.notify(selectCustomer, notification, JOptionPane.WARNING_MESSAGE);
        }
    }//GEN-LAST:event_btnUpdateActionPerformed

    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        if (customer != null) {
            int click = JOptionPane.showConfirmDialog(null, deleteCus, notification, 2);
            if (click == JOptionPane.YES_OPTION) {
                boolean b = Dao_Customer.delete(customer.getCustomerID(), "Disable");
                if (b) {
                    Common.notify(deletedCus, notification, JOptionPane.INFORMATION_MESSAGE);
                    getCustomers(Dao_Customer.getCustomers());
                    refresh();
                } else {
                    Common.notify(notDeleteCus, notification, JOptionPane.ERROR_MESSAGE);
                }
            }
        } else {
            Common.notify(selectCustomer, notification, JOptionPane.WARNING_MESSAGE);
