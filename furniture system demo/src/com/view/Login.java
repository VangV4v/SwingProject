...
public class Login extends javax.swing.JFrame {
    ...
    public void tranSac() {
        String ngonngu = String.valueOf(jComboBox1.getSelectedItem());
        String vn = "VN";
        String uk = "UK";

        if (ngonngu.equals(uk)) {
            Locale local = null;
            ResourceBundle resource = null;
            try {
                local = new Locale("en_UK");
                resource = ResourceBundle.getBundle("com.language.Tran", local);
                jLabel2.setText(resource.getString("username"));
                jLabel3.setText(resource.getString("password"));
                jLabel1.setText(resource.getString("header"));
                jButton4.setText(resource.getString("fogetpass"));
                Buttonexit.setText(resource.getString("exit"));
                btnLoginAdmin.setText(resource.getString("loginAdmin"));
                btnLoginStaff.setText(resource.getString("loginStaff"));
                loi1 = resource.getString("dangnhaptc");
                loi2 = resource.getString("dangnhaptb");
                loi3 = resource.getString("nhaptk");

            } catch (Exception e) {
            }
        }
        if (ngonngu.equals(vn)) {
            Locale local = null;
            ResourceBundle resource = null;
            try {
        ...
        HomePageAdmin homePageAdmin = new HomePageAdmin(ngonngu);
        MainAdmin maninadmin = new MainAdmin(ngonngu);
        Products pro = new Products(ngonngu);
        Staffs staff = new Staffs(ngonngu);
        Categories cate = new Categories(ngonngu);
        Suppliers sup = new Suppliers(ngonngu);
        Promotions proa = new Promotions(ngonngu);
        Shippers ship = new Shippers(ngonngu);
        Reports report = new Reports(ngonngu);
        HomePageStaff homestaff = new HomePageStaff(ngonngu);
        MainStaff mainstaff = new MainStaff(ngonngu);
        Users user = new Users(ngonngu);
        ChangePassword change = new ChangePassword(ngonngu);
        Orders order = new Orders(ngonngu);
        Customers customer = new Customers(ngonngu);
        ForfotPassword forgot = new ForfotPassword(ngonngu);
        Search search = new Search(ngonngu, "Translate");
    }
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "UK", "VN", "US", "Item 4" }));
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/img/Language.png"))); // NOI18N
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ForfotPassword fp = new ForfotPassword();
        jlogin.dispose();
