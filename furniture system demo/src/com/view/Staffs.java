...
public class Staffs extends javax.swing.JPanel {
    ...
    public void dich() {
        ...
        if (nn.equals(vn)) {
            ...
            try {
                ...
                jLabel17.setText(resource.getString("staffmanage"));
                ...
                jLabel6.setText(resource.getString("gender"));
                jLabel7.setText(resource.getString("staffname"));
                nam.setText(resource.getString("male"));
                nu.setText(resource.getString("female"));

                jLabel10.setText(resource.getString("address"));
                jLabel12.setText(resource.getString("phone"));
                jLabel13.setText(resource.getString("username"));
                jLabel11.setText(resource.getString("password"));
                jLabel8.setText(resource.getString("hiredate"));
                jLabel9.setText(resource.getString("birthdate"));
                jLabel14.setText(resource.getString("password"));
                jLabel15.setText(resource.getString("status"));
                jRadioButton4.setText(resource.getString("enable"));
        ...
        try {
            ...
            while (rs.next()) {
                ...
                if (rs.getString(8).equals(aa) || jTextField9.getText().equals("project")) {
                    JOptionPane.showMessageDialog(null, "Tai Khoan Da Duoc Dang Ki");
                    break;
                }
                break;
            }
    ...
    public void checkDKNV() {
        ...
        boolean aa = Pattern.matches("^[a-zA-Z][\\w-]+@([\\w]+\\.[\\w]+|[\\w]+\\.[\\w]{2,}\\.[\\w]{2,})$", jTextField11.getText());
        ...
        if (a.equals("") && b.equals("") && c.equals("") && d.equals("") && e.equals("")) {
            ...
            JOptionPane.showMessageDialog(null, "Sai Dinh Dang Email!");
            jTextField11.setText("");
        } else if (dd == false) {
            JOptionPane.showMessageDialog(null, "So Dien Thoai Phai La Dang So!");
        } else if (c.length() > 30 || d.length() > 30) {
            JOptionPane.showMessageDialog(null, "TK,MK Khong The Vuot Qua 30 ki tu");
