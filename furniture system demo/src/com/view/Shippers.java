...
public class Shippers extends javax.swing.JPanel {
    ...
    public void dich() {
        ...
        if (nn.equals(vn)) {
            ...
            try {
                ...
                jLabel14.setText(resource.getString("shippermanage"));
                ...
                jLabel8.setText(resource.getString("companyname"));
                jLabel9.setText(resource.getString("phone"));

                jLabel11.setText(resource.getString("status"));
                jRadioButton2.setText(resource.getString("enable"));
        ...
        try {
            ...
            while (rs.next()) {
                if (rs.getString(2).equals(com.getText())) {
                    JOptionPane.showMessageDialog(null, "Da Hop Tac Voi Company !");
                    bl = true;
                }
            }
            if (!bl) {
    ...
    public void chek() {
        ...
        if (phone.equals("") || co.equals("")) {
            ...
            JOptionPane.showMessageDialog(null, "Vui Long Nhap Dung Dinh Dang SDT!!");
