...
public class Categories extends javax.swing.JPanel {
    ...
    String id, name, des, searchCate, notFound, error, enterCateName, enterDes, added, enterCateID, updated;
    ...
    public void dich() {
        ...
        if (nn.equals(vn)) {
            ...
            try {
                ...
                jButton13.setText(resource.getString("search"));
                jButton14.setText(resource.getString("reset"));
                jLabel6.setText(resource.getString("description"));
                jLabel7.setText(resource.getString("categoryname"));
                ...
                id = resource.getString("categoryid");
                name = resource.getString("categoryname");
                des = resource.getString("description");
                jLabel14.setText(resource.getString("categorymanage"));
                searchCate = resource.getString("searchCate");
                notFound = resource.getString("notFound");
                error = resource.getString("error");
                enterCateName = resource.getString("enterCateName");
                enterDes = resource.getString("enterDes");
                added = resource.getString("added");
                enterCateID = resource.getString("enterCateID");
    ...
    private void initable() {
        ...
        tableModel.setColumnIdentifiers(new String[]{id, name, des});
    ...
    private void jButton13ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton13ActionPerformed
        if (txtid.getText().equals("")) {
            JOptionPane.showConfirmDialog(this, searchCate);
            return;
        }
        try {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (txtname.getText().equals("")) {
            ...
            JOptionPane.showConfirmDialog(this, enterCateName);
        } else if (txtcomment.getText().equals("")) {

            JOptionPane.showConfirmDialog(this, enterDes);
        } else {
            if (sb.length() > 0) {
